...
def fig1_pressure_flow(phys: PipelinePhysics, leak: LeakSimulator):
    ...
    ax1.set_title("(a) Spatial Pressure Profile - Leak Hidden in Noise\n"
                  "dp = 0.005 bar (buried in +/-1.5 bar noise)")
    ...
    _save_split_panels(fig, [
        ("Fig1_Spatial_Pressure_Profile.svg", [ax1, ins]),
        ("Fig1_Outlet_Flow_Rate.svg", [ax2]),
    ])
    _save(fig, "Fig1_Pressure_Flow.svg")
